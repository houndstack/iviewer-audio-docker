...
with gr.Blocks(css=css) as demo:
    with gr.Column(elem_id="copilot"):
        ...
        with gr.Row():
            ...
            record_btn = gr.Button(value="Record", elem_classes="button", size='sm', min_width=10)

        #mic = gr.Audio(sources=["microphone"], visible=True, streaming=True)
        #mic.change(transcribe, mic, comment)
        gr.Interface(
            transcribe,
